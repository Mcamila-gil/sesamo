...
<body>
 ...
 <form method="post" enctype="multipart/form-data">
            ...
            <label>Tipo</label>
            <select name="idTipo" value="<?php echo $row ['idTipo']; ?>" required>
            ...
            <input style="color: white" type="file" name="foto" value="<?php echo $row ['foto']; ?>" id="foto" required>
            <label>Precio</label>
            <input name="precio" type="number" value="<?php echo $row ['precio']; ?>" min="1" required>
            <label>Descripción</label>
            <textarea name="descripcion" value="<?php echo $row ['descripcion']; ?>" placeholder="Ej: Queso gratinado, salsa roja mexicana y frijoles" rows="6" required></textarea>
